...
export default function Table({data, title, isLoading, handleTableAdd, handleTableEdit, handleTableDelete, columns, options, ...props}) {
    return (
        <MaterialTable
            isLoading={isLoading}
            title={title}
            ...
            editable={{
                onRowAdd: newData =>
                    new Promise((resolve, reject) => {
                        handleTableAdd(newData, resolve, reject);
                    }),
                onRowUpdate: (newData, oldData) =>
                    new Promise((resolve, reject) => {
                        handleTableEdit(newData, oldData, resolve, reject);
                    }),
                onRowDelete: oldData =>
                    new Promise((resolve, reject) => {
